...
In R lassen sich außerdem sehr einfach sogenannte Modelle definieren, welche als Eingabe nur die Daten und eine Formel benötigen. Eine Formel ist von der Form $y \sim modell$ und enthält den funktionalen Zusammenhang zwischen der abhängigen und den unabhängigen Variablen. Mit diesen linearen Modellen berechnet man schnell und einfach die Parameter zu einem gegebenen Datensatz unter Verwendung der $lm$-Funktion in R.
